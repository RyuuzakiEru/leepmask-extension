...
const { getNetworkTypeFromCode } = require('./../../../app/scripts/controllers/network/util')
const networks = require('./../../../app/scripts/controllers/network/networks')
...
TransactionListItem.prototype.render = function () {
  ...
  isLinkable = numericNet === 1 || numericNet === 3 || numericNet === 4 || numericNet === 42 || numericNet === 61 || numericNet === 820
  ...
  return (
    h('.transaction-list-item.flex-column', {
      onClick: (event) => {
        ...
        const url = typeof (networks.networkList[getNetworkTypeFromCode(network)].blockExplorerTx) === 'function' ? networks.networkList[getNetworkTypeFromCode(network)].blockExplorerTx(transaction.hash) : explorerLink(transaction.hash, parseInt(network))
