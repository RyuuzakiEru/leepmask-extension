...
AccountDetailScreen.prototype.render = function () {
  ...
  const { network, conversionRate, currentCurrency, nativeCurrency } = props

  if (Object.keys(props.suggestedTokens).length > 0) {
    this.props.dispatch(actions.showAddSuggestedTokenPage())
  }
  const buyButtonDisplayProperty = (nativeCurrency === 'ETH') ? 'block' : 'none'
  return (
      ...
      h('.account-data-subsection', {
        ...
        h('.flex-row', {
          ...
          h('button', {
            ...
            style: { marginRight: '10px', display: buyButtonDisplayProperty },
          }, 'BUY'),
